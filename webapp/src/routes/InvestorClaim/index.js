...
const InvestorClaim = () => {
  ...
  const { t } = useTranslation('InvestorClaimRoute')
  ...
  const handleOnSubmit = async () => {
    try {
      const response = await tokenSaleUtil.investorClaim(user, payload)
...
InvestorClaim.propTypes = {}

export default memo(InvestorClaim)
