...
const ApprovePool = () => {
  ...
  const { t } = useTranslation('ApprovePoolRoute')
  ...
  const handleOnSubmit = async () => {
    try {
      const response = await tokenSaleUtil.approvePool(user, payload)
...
ApprovePool.propTypes = {}

export default memo(ApprovePool)
